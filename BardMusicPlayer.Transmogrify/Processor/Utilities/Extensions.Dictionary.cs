...
namespace BardMusicPlayer.Transmogrify.Processor.Utilities
{
    internal static partial class Extensions
    {
        ...
        {
            return await MoveNoteDictionaryToDefaultOctave(await sourceNotesDictionary, sourceOctaveRange);
        }
        ...
        {
            return await GetNoteDictionary(trackChunks, tempoMap, tone, new Dictionary<int, (int, int)>(), lowClamp,
                highClamp, startingChannel, readTones, noteSampleOffset);
        }
        ...
        {
            return await GetNoteDictionary(new List<TrackChunk> { trackChunk }, tempoMap, tone, mapper, lowClamp,
                highClamp, startingChannel, readTones, noteSampleOffset);
        }
        ...
        {
            return await GetNoteDictionary(new List<TrackChunk> { trackChunk }, tempoMap, tone,
        ...
        {
            return await GetPlayerNoteDictionary(await trackChunk, playerCount, lowClamp, highClamp);
        }
        ...
        {
            return await ConcatNoteDictionaryToList(await sourceNotesDictionary);
        }
    }
}