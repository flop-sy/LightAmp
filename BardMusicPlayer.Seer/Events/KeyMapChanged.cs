...
namespace BardMusicPlayer.Seer.Events
{
    ...
    {
        internal KeyMapChanged(EventSource readerBackendType, IDictionary<Instrument, Keys> instrumentKeys,
            IDictionary<InstrumentTone, Keys> instrumentToneKeys,
            IDictionary<NavigationMenuKey, Keys> navigationMenuKeys,
            IDictionary<InstrumentToneMenuKey, Keys> instrumentToneMenuKeys, IDictionary<NoteKey, Keys> noteKeys) :
            base(readerBackendType)
        {
            EventType = GetType();
