...
namespace BardMusicPlayer.Seer.Utilities.KnownFolder
{
    ...
    internal sealed class KnownFolder
    {
        ...
        /// <param name="type">The <see cref="KnownFolderType" /> of the known folder to represent.</param>
        /// <param name="identity">
        ///     The <see cref="WindowsIdentity" /> of the impersonated user which values will be
        ///     provided.
        /// </param>
        ...
        /// </summary>
        internal KnownFolderType Type { get; }
        ...
        internal string DefaultPath => GetPath(KnownFolderFlags.DontVerify | KnownFolderFlags.DefaultPath);
        ...
        ///     more of the <see cref="KnownFolderFlags" /> values.
        /// </param>
        /// <param name="hToken">
