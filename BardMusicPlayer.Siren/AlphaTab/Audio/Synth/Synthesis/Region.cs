        ...
        internal void Operator(ushort genOper, HydraGenAmount amount)
        {
            switch ((GenOperators)genOper)
            {
                case GenOperators.StartAddrsOffset:
                    Offset += (uint)amount.ShortAmount;
                    break;
                case GenOperators.EndAddrsOffset:
                    End += (uint)amount.ShortAmount;
                    break;
                case GenOperators.StartloopAddrsOffset:
                    LoopStart += (uint)amount.ShortAmount;
                    break;
                case GenOperators.EndloopAddrsOffset:
                    LoopEnd += (uint)amount.ShortAmount;
                    break;
                case GenOperators.StartAddrsCoarseOffset:
                    Offset += (uint)amount.ShortAmount * 32768;
                    break;
                case GenOperators.ModLfoToPitch:
                    ModLfoToPitch = amount.ShortAmount;
                    break;
                case GenOperators.VibLfoToPitch:
                    VibLfoToPitch = amount.ShortAmount;
                    break;
                case GenOperators.ModEnvToPitch:
                    ModEnvToPitch = amount.ShortAmount;
                    break;
                case GenOperators.InitialFilterFc:
                    InitialFilterFc = amount.ShortAmount;
                    break;
                case GenOperators.InitialFilterQ:
                    InitialFilterQ = amount.ShortAmount;
                    break;
                case GenOperators.ModLfoToFilterFc:
                    ModLfoToFilterFc = amount.ShortAmount;
                    break;
                case GenOperators.ModEnvToFilterFc:
                    ModEnvToFilterFc = amount.ShortAmount;
                    break;
                case GenOperators.EndAddrsCoarseOffset:
                    End += (uint)amount.ShortAmount * 32768;
                    break;
                case GenOperators.ModLfoToVolume:
                    ModLfoToVolume = amount.ShortAmount;
                    break;
                case GenOperators.Pan:
                    Pan = amount.ShortAmount / 1000.0f;
                    break;
                case GenOperators.DelayModLFO:
                    DelayModLFO = amount.ShortAmount;
                    break;
                case GenOperators.FreqModLFO:
                    FreqModLFO = amount.ShortAmount;
                    break;
                case GenOperators.DelayVibLFO:
                    DelayVibLFO = amount.ShortAmount;
                    break;
                case GenOperators.FreqVibLFO:
                    FreqVibLFO = amount.ShortAmount;
                    break;
                case GenOperators.DelayModEnv:
                    ModEnv.Delay = amount.ShortAmount;
                    break;
                case GenOperators.AttackModEnv:
                    ModEnv.Attack = amount.ShortAmount;
                    break;
                case GenOperators.HoldModEnv:
                    ModEnv.Hold = amount.ShortAmount;
                    break;
                case GenOperators.DecayModEnv:
                    ModEnv.Decay = amount.ShortAmount;
                    break;
                case GenOperators.SustainModEnv:
                    ModEnv.Sustain = amount.ShortAmount;
                    break;
                case GenOperators.ReleaseModEnv:
                    ModEnv.Release = amount.ShortAmount;
                    break;
                case GenOperators.KeynumToModEnvHold:
                    ModEnv.KeynumToHold = amount.ShortAmount;
                    break;
                case GenOperators.KeynumToModEnvDecay:
                    ModEnv.KeynumToDecay = amount.ShortAmount;
                    break;
                case GenOperators.DelayVolEnv:
                    AmpEnv.Delay = amount.ShortAmount;
                    break;
                case GenOperators.AttackVolEnv:
                    AmpEnv.Attack = amount.ShortAmount;
                    break;
                case GenOperators.HoldVolEnv:
                    AmpEnv.Hold = amount.ShortAmount;
                    break;
                case GenOperators.DecayVolEnv:
                    AmpEnv.Decay = amount.ShortAmount;
                    break;
                case GenOperators.SustainVolEnv:
                    AmpEnv.Sustain = amount.ShortAmount;
                    break;
                case GenOperators.ReleaseVolEnv:
                    AmpEnv.Release = amount.ShortAmount;
                    break;
                case GenOperators.KeynumToVolEnvHold:
                    AmpEnv.KeynumToHold = amount.ShortAmount;
                    break;
                case GenOperators.KeynumToVolEnvDecay:
                    AmpEnv.KeynumToDecay = amount.ShortAmount;
                    break;
                case GenOperators.KeyRange:
                    LoKey = amount.LowByteAmount;
                    HiKey = amount.HighByteAmount;
                    break;
                case GenOperators.VelRange:
                    LoVel = amount.LowByteAmount;
                    HiVel = amount.HighByteAmount;
                    break;
                case GenOperators.StartloopAddrsCoarseOffset:
                    LoopStart += (uint)amount.ShortAmount * 32768;
                    break;
                case GenOperators.InitialAttenuation:
                    Attenuation += amount.ShortAmount * 0.1f;
                    break;
                case GenOperators.EndloopAddrsCoarseOffset:
                    LoopEnd += (uint)amount.ShortAmount * 32768;
                    break;
                case GenOperators.CoarseTune:
                    Transpose += amount.ShortAmount;
                    break;
                case GenOperators.FineTune:
                    Tune += amount.ShortAmount;
                    break;
                case GenOperators.SampleModes:
                    LoopMode = (amount.WordAmount & 3) == 3 ? LoopMode.Sustain :
                        (amount.WordAmount & 3) == 1 ? LoopMode.Continuous : LoopMode.None;
                    break;
                case GenOperators.ScaleTuning:
                    PitchKeyTrack = amount.ShortAmount;
                    break;
                case GenOperators.ExclusiveClass:
                    Group = amount.WordAmount;
                    break;
                case GenOperators.OverridingRootKey:
                    PitchKeyCenter = amount.ShortAmount;
                    break;
            }
        }
