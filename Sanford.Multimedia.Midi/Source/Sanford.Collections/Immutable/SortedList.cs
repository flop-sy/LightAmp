...
public class SortedList : IEnumerable
{
    ...
    ///     An empty SortedList.
    /// </summary>
    public static readonly SortedList Empty = new();
    ...
    {
        if (comparer == null)
            compareHandler = CompareWithoutComparer;
        else
            compareHandler = CompareWithComparer;
    }
    ...
    /// </summary>
    private sealed class SortedListEnumerator : IDictionaryEnumerator
    {
