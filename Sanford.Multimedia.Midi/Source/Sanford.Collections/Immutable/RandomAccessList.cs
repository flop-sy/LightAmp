    ...
    public class RandomAccessList : IEnumerable
    {
        ...
        public RandomAccessList Cons(object value)
        {
                ...
                first.Root.Count < first.NextNode.Root.Count)
            {
                ...
                var newRoot = new RalTreeNode(value, null, null);
        ...
        public RandomAccessList Head
        {
            get
            {
                ...
                var newFirst = new RalTopNode(newRoot, null);
        ...
        public RandomAccessList Tail
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        var left = first.Root.LeftChild;
                        var right = first.Root.RightChild;

                        var newSecond = new RalTopNode(
                            right, first.NextNode);
                        var newFirst = new RalTopNode(
                            left, newSecond);
