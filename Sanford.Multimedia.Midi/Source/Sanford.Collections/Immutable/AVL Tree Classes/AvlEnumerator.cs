...
namespace Sanford.Collections.Immutable
{
    ...
    /// </summary>
    internal sealed class AvlEnumerator : IEnumerator
    {
        ...
        private readonly System.Collections.Stack nodeStack = new System.Collections.Stack();
        ...
        public bool MoveNext()
        {
            ...
            {
                // Get the next node.
                var currentNode = (IAvlNode)nodeStack.Pop();
