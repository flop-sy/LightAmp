...
namespace Sanford.Collections
{
    ...
    public class SkipList : IDictionary
    {
        ...
        private class Node : IDisposable
        {
            ...
            public void Dispose()
            {
                for (var i = 0; i < forward.Length; i++) forward[i] = null;
            }
        ...
        private readonly Node header = new Node(MaxLevel);
        ...
        private void Initialize()
        {
            ...
            for (var i = 0; i < MaxLevel; i++) header.forward[i] = header;
        }
        ...
        ///     Returns true if the specified key is in the SkipList.
        /// </returns>
        private bool Search(object key, IList<Node> update)
        {
        ...
        ///     Returns true if the specified key is in the SkipList.
        /// </returns>
        private bool Search(object key, out Node curr, IList<Node> update)
        {
            // Make sure key isn't null.
            if (key == null) throw new ArgumentNullException("An attempt was made to pass a null key to a SkipList.");
        ...
        /// </param>
        private void Insert(object key, object val, IList<Node> update)
        {
            ...
            if (newLevel > listLevel)
            {
                ...
                for (var i = listLevel; i < newLevel; i++) update[i] = header;
        ...
        public void Remove(object key)
        {
            ...
            if (!Search(key, out var curr, update)) return;
            ...
            // the nodes.
            while (listLevel > 1 && header.forward[listLevel - 1] == header) listLevel--;
        ...
        public object this[object key]
        {
            get
            {
                ...
                if (Search(key, out var curr)) val = curr.Entry.Value;
            ...
            set
            {
                ...
                if (Search(key, out var curr, update))
                {
