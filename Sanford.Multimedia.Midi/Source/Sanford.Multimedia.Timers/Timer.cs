...
internal sealed class Timer : ITimer
{
    ...
    public void Start()
    {
        ...
        // Create and start timer.
        timerID = timeSetEvent(Period, Resolution, Mode == TimerMode.Periodic ? timeProcPeriodic : timeProcOneShot,
            IntPtr.Zero, (int)Mode);
...
/// </summary>
public sealed class TimerStartException : ApplicationException
{
    /// <summary>
