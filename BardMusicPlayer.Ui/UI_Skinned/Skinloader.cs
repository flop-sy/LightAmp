...
namespace BardMusicPlayer.Ui.Skinned
{
    public partial class Skinned_MainView : UserControl
    {
        ...
        public void LoadSkin(string filename)
        {
            ...
            var visdata = ExtractViscolorFromZip(filename, "viscolor.txt");
            SkinContainer.VISCOLOR.Add(SkinContainer.VISCOLOR_TYPES.VISCOLOR_BACKGROUND,
                GetColor(visdata[(int)SkinContainer.VISCOLOR_TYPES.VISCOLOR_BACKGROUND]));
        ...
        private void ApplySkin()
        {
            ...
            TitleBar.Fill = SkinContainer.TITLEBAR[SkinContainer.TITLEBAR_TYPES.MAIN_TITLE_BAR_SELECTED];
            ...
            Second_First.Fill = SkinContainer.NUMBERS[0];
            Second_Last.Fill = SkinContainer.NUMBERS[0];
            Minutes_First.Fill = SkinContainer.NUMBERS[0];
            Minutes_Last.Fill = SkinContainer.NUMBERS[0];

            Trackbar_Background.Fill = SkinContainer.VOLUME[SkinContainer.VOLUME_TYPES.MAIN_VOLUME_BACKGROUND_0];
            Octavebar_Background.Fill = SkinContainer.VOLUME[SkinContainer.VOLUME_TYPES.MAIN_VOLUME_BACKGROUND_5];

            //set the global resources
            Application.Current.Resources["MAIN_VOLUME_THUMB"] =
                SkinContainer.VOLUME[SkinContainer.VOLUME_TYPES.MAIN_VOLUME_THUMB];
            Application.Current.Resources["MAIN_VOLUME_THUMB_SELECTED"] =
                SkinContainer.VOLUME[SkinContainer.VOLUME_TYPES.MAIN_VOLUME_THUMB_SELECTED];
            Application.Current.Resources["MAIN_BALANCE_THUMB"] =
                SkinContainer.BALANCE[SkinContainer.BALANCE_TYPES.MAIN_BALANCE_THUMB];
            Application.Current.Resources["MAIN_BALANCE_THUMB_SELECTED"] =
                SkinContainer.BALANCE[SkinContainer.BALANCE_TYPES.MAIN_BALANCE_THUMB_SELECTED];
        ...
        private readonly Dictionary<SkinContainer.CBUTTON_TYPES, List<int>> cbuttonsdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.NUMBER_TYPES, List<int>> numbersdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.TITLEBAR_TYPES, List<int>> titlebardata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.VOLUME_TYPES, List<int>> volumedata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.BALANCE_TYPES, List<int>> balancedata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.EQ_TYPES, List<int>> eqdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.SHUFREP_TYPES, List<int>> shufrepdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.MEDIABROWSER_TYPES, List<int>> mediabrowserdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.GENEX_TYPES, List<int>> genexdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.PLAYLIST_TYPES, List<int>> playlistdata = new()
        {
        ...
        private readonly Dictionary<SkinContainer.SWINDOW_TYPES, List<int>> swindowdata = new()
        {
        ...
        private void loadTitlebarAndButtons(string filename)
        {
            ...
            foreach (var data in titlebardata)
            {
                ...
                var graphics = Graphics.FromImage(bitmap);
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.TITLEBAR.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
        ...
        private void loadVolumebar(string filename)
        {
            ...
            foreach (var data in volumedata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.VOLUME.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadBalancebar(string filename)
        {
            ...
            foreach (var data in balancedata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.BALANCE.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadControlButtons(string filename)
        {
            ...
            foreach (var data in cbuttonsdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.CBUTTONS.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadPlaylistDesign(string filename)
        {
            ...
            foreach (var data in playlistdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.PLAYLIST.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
            ...
            Application.Current.Resources["PLAYLIST_SLIDER_THUMB"] =
                SkinContainer.PLAYLIST[SkinContainer.PLAYLIST_TYPES.PLAYLIST_SCROLL_HANDLE];
            Application.Current.Resources["PLAYLIST_SLIDER_THUMB_SELECTED"] =
                SkinContainer.PLAYLIST[SkinContainer.PLAYLIST_TYPES.PLAYLIST_SCROLL_HANDLE_SELECTED];
        }
        ...
        private void loadEqBackGround(string filename)
        {
            ...
            //foreach (KeyValuePair<SkinContainer.EQ_TYPES, List<int>> data in eqdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.EQUALIZER.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadShufRepDesign(string filename)
        {
            ...
            foreach (var data in shufrepdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.SHUFREP.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadMediaBrowserWindow(string filename)
        {
            ...
            foreach (var data in mediabrowserdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.MEDIABROWSER.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadAVSWindow(string filename)
        {
            ...
            foreach (var data in swindowdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.SWINDOW.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        private void loadNumbersAndFont(string filename)
        {
            ...
            foreach (var data in numbersdata)
            {
                ...
                graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                    new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                        data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                SkinContainer.NUMBERS.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                    bitmap.GetHbitmap(), IntPtr.Zero,
                    Int32Rect.Empty,
                    BitmapSizeOptions.FromEmptyOptions())));
                bitmap.Dispose();
        ...
        {
            //Buttons / or similar
            var img = ExtractImageFromZip(filename, "genex.bmp");
            if (img != null)
            {
                foreach (var data in genexdata)
                {
                    var bitmap = new Bitmap(data.Value.ElementAt(2), data.Value.ElementAt(3));
                    var graphics = Graphics.FromImage(bitmap);
                    graphics.DrawImage(img, new Rectangle(0, 0, data.Value.ElementAt(2), data.Value.ElementAt(3)),
                        new Rectangle(data.Value.ElementAt(0), data.Value.ElementAt(1), data.Value.ElementAt(2),
                            data.Value.ElementAt(3)), GraphicsUnit.Pixel);
                    SkinContainer.GENEX.Add(data.Key, new ImageBrush(Imaging.CreateBitmapSourceFromHBitmap(
                        bitmap.GetHbitmap(), IntPtr.Zero,
                        Int32Rect.Empty,
                        BitmapSizeOptions.FromEmptyOptions())));
                    bitmap.Dispose();
            ...
            {
                var data = genexdata[SkinContainer.GENEX_TYPES.GENEX_SCROLL_LEFT_UNPRESSED];
                var bitmap = new Bitmap(data.ElementAt(2) - 2, data.ElementAt(3) - 2);
                var graphics = Graphics.FromImage(bitmap);
                graphics.DrawImage(SkinContainer.FONT[68], 0, 0);
                SkinContainer.GENEX.Add(SkinContainer.GENEX_TYPES.GENEX_SCROLL_LEFT_UNPRESSED, new ImageBrush(
                    Imaging.CreateBitmapSourceFromHBitmap(bitmap.GetHbitmap(), IntPtr.Zero,
                        Int32Rect.Empty,
                        BitmapSizeOptions.FromEmptyOptions())));
                SkinContainer.GENEX.Add(SkinContainer.GENEX_TYPES.GENEX_SCROLL_LEFT_PRESSED, new ImageBrush(
                    Imaging.CreateBitmapSourceFromHBitmap(bitmap.GetHbitmap(), IntPtr.Zero,
                        Int32Rect.Empty,
                        BitmapSizeOptions.FromEmptyOptions())));
                graphics = Graphics.FromImage(bitmap);
                graphics.DrawImage(SkinContainer.FONT[85], 0, 0);
                SkinContainer.GENEX.Add(SkinContainer.GENEX_TYPES.GENEX_SCROLL_RIGHT_UNPRESSED, new ImageBrush(
                    Imaging.CreateBitmapSourceFromHBitmap(bitmap.GetHbitmap(), IntPtr.Zero,
                        Int32Rect.Empty,
                        BitmapSizeOptions.FromEmptyOptions())));
                SkinContainer.GENEX.Add(SkinContainer.GENEX_TYPES.GENEX_SCROLL_RIGHT_PRESSED, new ImageBrush(
                    Imaging.CreateBitmapSourceFromHBitmap(bitmap.GetHbitmap(), IntPtr.Zero,
                        Int32Rect.Empty,
                        BitmapSizeOptions.FromEmptyOptions())));

                SkinContainer.GENEX[SkinContainer.GENEX_TYPES.GENEX_SCROLL_RIGHT_UNPRESSED].Stretch =
                    Stretch.UniformToFill;
                SkinContainer.GENEX[SkinContainer.GENEX_TYPES.GENEX_SCROLL_LEFT_UNPRESSED].Stretch =
                    Stretch.UniformToFill;
                bitmap.Dispose();
            }
        }
        ...
        {
            SkinContainer.PLAYLISTCOLOR.Add(SkinContainer.PLAYLISTCOLOR_TYPES.PLAYLISTCOLOR_NORMAL,
                GetColorFromHex("Normal=#C4FFC4"));
            SkinContainer.PLAYLISTCOLOR.Add(SkinContainer.PLAYLISTCOLOR_TYPES.PLAYLISTCOLOR_CURRENT,
                GetColorFromHex("Normal=#FFFFFF"));
            SkinContainer.PLAYLISTCOLOR.Add(SkinContainer.PLAYLISTCOLOR_TYPES.PLAYLISTCOLOR_NORMALBG,
                GetColorFromHex("Normal=#000000"));
            SkinContainer.PLAYLISTCOLOR.Add(SkinContainer.PLAYLISTCOLOR_TYPES.PLAYLISTCOLOR_SELECTBG,
                GetColorFromHex("Normal=#6B6B6F"));
            SkinContainer.PLAYLISTCOLOR.Add(SkinContainer.PLAYLISTCOLOR_TYPES.PLAYLISTCOLOR_MBBG,
                GetColorFromHex("Normal=#000000"));
            SkinContainer.PLAYLISTCOLOR.Add(SkinContainer.PLAYLISTCOLOR_TYPES.PLAYLISTCOLOR_MBFG,
                GetColorFromHex("Normal=#FFFFFF"));
            ZipArchive zip;
            try
            {
        ...
        private List<string> ExtractViscolorFromZip(string archivename, string imagename)
        {
            ZipArchive zip;
            try
            {
        ...
        private ImageBrush ExtractImage(Image img, int x, int y, int offset_x, int offset_y)
        {
            ...
            graphics.DrawImage(img, new Rectangle(0, 0, x, y), new Rectangle(offset_x, offset_y, x, y),
                GraphicsUnit.Pixel);
            graphics.Dispose();
        ...
        private ImageAttributes GetTransparentAttribFromColor()
        {
            var lowerColor = Color.FromArgb(100, 0, 100);
            var upperColor = Color.FromArgb(100, 0, 100);
