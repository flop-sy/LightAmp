...
namespace BardMusicPlayer.Ui.Controls
{
    ...
    public sealed partial class BardExtSettingsWindow
    {
        ...
        private void Save_CPU_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (mask == 0)
            {
                var result = MessageBox.Show("No CPU was selected", "Error Affinity", MessageBoxButton.OK,
        ...
        {
            foreach (var box in _cpuBoxes) box.IsChecked = false;
        }

        private void Reset_CPU_Click(object sender, RoutedEventArgs e)
        {
            foreach (var box in _cpuBoxes) box.IsChecked = true;
        }
