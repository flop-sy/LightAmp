...
public static partial class GameExtensions
{
    ...
    ///     Note that in addition to the delay value, using any modifier key will add an mandatory 25ms delay loop to allow the
    ///     game to capture said modifier input.
    /// </summary>
    ...
    /// <summary>
    ///     Named opposite of behavior, this runs async in this thread, sync to sendmessage the ffixv game.
    ///     Note that in addition to the delay value, using any modifier key will add a mandatory 5ms delay per modifier allow
    ///     the game to capture said modifier input.
    /// </summary>
    /// <param name="game"></param>
    /// <param name="key"></param>
    /// <param name="delay"></param>
    ...
    /// <summary>
    ///     Named opposite of behavior, this runs async in this thread, sync to sendmessage the ffixv game.
    ///     Note that in addition to the delay values, using modifier keys will add 30-45ms extra delay depending on how many
    ...
    {
        return await SyncPushKey(game, key, downDelay) && await SyncReleaseKey(game, key, upDelay);
    }
