...
namespace BardMusicPlayer.Maestro.FFXIV
{
    public sealed class FFXIVHook
    {
        ...
        {
            if (keyDown != Keys.None) SendAsyncKey(keyDown | modDown, true, true, false);
        ...
        {
            if (GetForegroundWindow() != mainWindowHandle) SetForegroundWindow(mainWindowHandle);
        ...
        public void SendKeybindDown(Keys keybind)
        {
            ...
            if (!lastPerformanceKeys.Contains(keybind)) lastPerformanceKeys.Add(keybind);
        }
        ...
        public void SendKeybindUp(Keys keybind)
        {
            ...
            if (lastPerformanceKeys.Contains(keybind)) lastPerformanceKeys.Remove(keybind);
        }

        public void ClearLastPerformanceKeybinds()
        {
            foreach (var keybind in lastPerformanceKeys.ToArray()) SendSyncKey(keybind, true, false);
