...
namespace BardMusicPlayer.Quotidian.Structs
{
    ...
    public readonly struct OctaveRange : IComparable, IConvertible, IComparable<OctaveRange>, IEquatable<OctaveRange>
    {
        ...
        /// <returns>
        ///     <c>true</c> if the specified <see cref="OctaveRange" /> is equal to the current
        ///     <see cref="OctaveRange" />; otherwise, <c>false</c>.
        /// </returns>
        public bool Equals(OctaveRange other)
        {
            return Index == other;
        }

        bool IEquatable<OctaveRange>.Equals(OctaveRange other)
        {
            return Equals(other);
        }
        ...
        {
            return obj is OctaveRange octaveRange && Equals(octaveRange);
        }
        ...
        {
            return (Name, Index, Lower, Upper, LowerNote, UpperNote, TrackNameOffset).GetHashCode();
        }

        public static implicit operator string(OctaveRange octaveRange)
        {
            return octaveRange.Name;
        }

        public static implicit operator OctaveRange(string name)
        {
            return Parse(name);
        }

        public static implicit operator int(OctaveRange octaveRange)
        {
            return octaveRange.Index;
        }

        public static implicit operator OctaveRange(int lower)
        {
            return Parse(lower);
        }
        ...
        /// <returns></returns>
        public string GetTrackName(Instrument instrument)
        {
            return instrument.Name + TrackNameOffset;
        }
