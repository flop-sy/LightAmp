...
{
    public static readonly Instrument None = new("None", 0, 122, OctaveRange.Invalid, false, 0, 0,
    ...
    public static readonly Instrument Cymbal = new("Cymbal", 14, 127, OctaveRange.C3toC6, false, 0, 3,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE4,
    ...
    public static readonly Instrument Trumpet = new("Trumpet", 15, 56, OctaveRange.C3toC6, true, 0, 4,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0,
        new ReadOnlyCollection<string>(new List<string> { "trumpets" }));

    public static readonly Instrument Trombone = new("Trombone", 16, 57, OctaveRange.C2toC5, true, 0, 4,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1,
        new ReadOnlyCollection<string>(new List<string> { "trombones" }));

    public static readonly Instrument Tuba = new("Tuba", 17, 58, OctaveRange.C1toC4, true, 0, 4,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2,
        new ReadOnlyCollection<string>(new List<string> { "tubas" }));

    public static readonly Instrument Horn = new("Horn", 18, 60, OctaveRange.C2toC5, true, 0, 4,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
        new ReadOnlyCollection<string>(new List<string> { "FrenchHorn", "frenchhorns", "horns" }));

    public static readonly Instrument Saxophone = new("Saxophone", 19, 65, OctaveRange.C3toC6, true, 0, 4,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE4,
    ...
    public static readonly Instrument Violin = new("Violin", 20, 40, OctaveRange.C3toC6, true, 0, 5,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0,
        new ReadOnlyCollection<string>(new List<string>()));

    public static readonly Instrument Viola = new("Viola", 21, 41, OctaveRange.C3toC6, true, 0, 5,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1,
        new ReadOnlyCollection<string>(new List<string>()));

    public static readonly Instrument Cello = new("Cello", 22, 42, OctaveRange.C2toC5, true, 0, 5,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2,
        new ReadOnlyCollection<string>(new List<string>()));

    public static readonly Instrument DoubleBass = new("DoubleBass", 23, 43, OctaveRange.C1toC4, true, 0, 5,
        InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
