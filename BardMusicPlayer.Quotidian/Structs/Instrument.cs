...
namespace BardMusicPlayer.Quotidian.Structs
{
    ...
    {
        public static readonly Instrument None = new("None", 0, 122, OctaveRange.Invalid, false, 50, 0,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0, new ReadOnlyCollection<string>(new List<string>()));

        public static readonly Instrument Harp = new("Harp", 1, 46, OctaveRange.C3toC6, false, 0, 1,
        ...
        public static readonly Instrument Piano = new("Piano", 2, 0, OctaveRange.C4toC7, false, 0, 1,
        ...
        public static readonly Instrument Lute = new("Lute", 3, 24, OctaveRange.C2toC5, false, 0, 1,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2,
            new ReadOnlyCollection<string>(new List<string> { "guitar", "guitars", "lutes" }));

        public static readonly Instrument Fiddle = new("Fiddle", 4, 45, OctaveRange.C2toC5, false, 0, 1,
        ...
        public static readonly Instrument Flute = new("Flute", 5, 73, OctaveRange.C4toC7, true, 0, 2,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0,
            new ReadOnlyCollection<string>(new List<string> { "flutes" }));

        public static readonly Instrument Oboe = new("Oboe", 6, 68, OctaveRange.C4toC7, true, 0, 2,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1,
            new ReadOnlyCollection<string>(new List<string> { "oboes" }));

        public static readonly Instrument Clarinet = new("Clarinet", 7, 71, OctaveRange.C3toC6, true, 0, 2,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2,
            new ReadOnlyCollection<string>(new List<string> { "clarinets" }));

        public static readonly Instrument Fife = new("Fife", 8, 72, OctaveRange.C5toC8, true, 0, 2,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
            new ReadOnlyCollection<string>(new List<string> { "fifes", "Piccolo", "piccolos", "ocarina", "ocarinas" }));

        public static readonly Instrument Panpipes = new("Panpipes", 9, 75, OctaveRange.C4toC7, true, 0, 2,
        ...
        public static readonly Instrument Timpani = new("Timpani", 10, 47, OctaveRange.C2toC5, false, 0, 3,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0,
            new ReadOnlyCollection<string>(new List<string> { "timpanis" }));

        public static readonly Instrument Bongo = new("Bongo", 11, 116, OctaveRange.C3toC6, false, 0, 3,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1,
            new ReadOnlyCollection<string>(new List<string> { "bongos" }));

        public static readonly Instrument BassDrum = new("BassDrum", 12, 117, OctaveRange.C2toC5, false, 0, 3,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2,
            new ReadOnlyCollection<string>(new List<string> { "bassdrums", "bass_drum", "bass_drums", "kick" }));

        public static readonly Instrument SnareDrum = new("SnareDrum", 13, 115, OctaveRange.C3toC6, false, 0, 3,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
            new ReadOnlyCollection<string>(new List<string> { "snaredrums", "Snare", "snare_drum", "RiceDrum" }));

        public static readonly Instrument Cymbal = new("Cymbal", 14, 127, OctaveRange.C3toC6, false, 50, 3,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE4,
        ...
        public static readonly Instrument Trumpet = new("Trumpet", 15, 56, OctaveRange.C3toC6, true, 50, 4,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0,
            new ReadOnlyCollection<string>(new List<string> { "trumpets", "Humpet" }));

        public static readonly Instrument Trombone = new("Trombone", 16, 57, OctaveRange.C2toC5, true, 50, 4,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1,
            new ReadOnlyCollection<string>(new List<string> { "trombones", "Tromboner" }));

        public static readonly Instrument Tuba = new("Tuba", 17, 58, OctaveRange.C1toC4, true, 50, 4,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2,
            new ReadOnlyCollection<string>(new List<string> { "tubas", "Booba" }));

        public static readonly Instrument Horn = new("Horn", 18, 60, OctaveRange.C2toC5, true, 50, 4,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
            new ReadOnlyCollection<string>(new List<string> { "FrenchHorn", "frenchhorns", "horns", "Horny" }));

        public static readonly Instrument Saxophone = new("Saxophone", 19, 65, OctaveRange.C3toC6, true, 50, 4,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE4,
            new ReadOnlyCollection<string>(new List<string> { "Sax", "AltoSaxophone", "AltoSax", "Sexophone" }));
        ...
        public static readonly Instrument Violin = new("Violin", 20, 40, OctaveRange.C3toC6, true, 50, 5,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0, new ReadOnlyCollection<string>(new List<string>()));

        public static readonly Instrument Viola = new("Viola", 21, 41, OctaveRange.C3toC6, true, 50, 5,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1, new ReadOnlyCollection<string>(new List<string>()));

        public static readonly Instrument Cello = new("Cello", 22, 42, OctaveRange.C2toC5, true, 50, 5,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE2, new ReadOnlyCollection<string>(new List<string>()));

        public static readonly Instrument DoubleBass = new("DoubleBass", 23, 43, OctaveRange.C1toC4, true, 50, 5,
            InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
        ...
        public static readonly Instrument ElectricGuitarOverdriven = new("ElectricGuitarOverdriven", 24, 29,
            OctaveRange.C2toC5, true, 50, 6, InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE0,
            new ReadOnlyCollection<string>(new List<string>
                { "Program:ElectricGuitar", "guitaroverdriven", "overdrivenguitar", "overdriven" }));

        public static readonly Instrument ElectricGuitarClean = new("ElectricGuitarClean", 25, 27, OctaveRange.C2toC5,
            true, 50, 6, InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE1,
        ...
        public static readonly Instrument ElectricGuitarPowerChords = new("ElectricGuitarPowerChords", 27, 30,
            OctaveRange.C1toC4, true, 50, 6, InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE3,
            new ReadOnlyCollection<string>(new List<string>
                { "ElectricGuitarPowerChord", "guitarpowerchords", "powerchords" }));

        public static readonly Instrument ElectricGuitarSpecial = new("ElectricGuitarSpecial", 28, 31,
            OctaveRange.C3toC6, false, 50, 6, InstrumentToneMenuKey.PERFORMANCE_MODE_EX_TONE4,
