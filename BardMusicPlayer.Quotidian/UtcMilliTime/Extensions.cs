    ...
    public static class Extensions
    {
        ...
        public static string ToIso8601String(this long timestamp, bool suppressMilliseconds = false)
        {
            if (suppressMilliseconds)
                return timestamp.ToUtcDateTime().ToString(Constants.iso_8601_without_milliseconds);
        ...
        public static long ToUtcMilliTime(this DateTime given)
        {
            return given.ToUniversalTime().Ticks / Constants.dotnet_ticks_per_millisecond -
                   Constants.dotnet_to_unix_milliseconds;
        }
        ...
        /// <returns>long</returns>
        public static long ToUtcMilliTime(this DateTimeOffset given)
        {
            return given.ToUnixTimeMilliseconds();
        }
        ...
        /// <returns>long</returns>
        public static long ToUtcMilliTime(this TimeSpan given)
        {
            return (long)given.TotalMilliseconds;
        }
        ...
        /// <returns>long</returns>
        public static long ToUtcMilliTime(this long unixtime)
        {
        ...
        /// <param name="timestamp">UtcMilliTime</param>
        /// <returns>long</returns>
        public static long ToUnixTime(this long timestamp)
        {
        ...
        {
            return (int)(interval / Constants.day_milliseconds);
        }
        ...
        {
            return (int)(interval % Constants.day_milliseconds) / Constants.hour_milliseconds;
        }
        ...
        {
            return (int)(interval - (interval.IntervalDays() * Constants.day_milliseconds +
                                     interval.IntervalHoursPart() * Constants.hour_milliseconds)) /
                   Constants.minute_milliseconds;
        }
        ...
        public static int IntervalSecondsPart(this long interval)
        {
            return (int)(interval - (interval.IntervalDays() * Constants.day_milliseconds +
                                     interval.IntervalHoursPart() * Constants.hour_milliseconds +
                                     interval.IntervalMinutesPart() * Constants.minute_milliseconds)) /
                   Constants.second_milliseconds;
        }
        ...
        public static short MillisecondPart(this long timestamp)
        {
            return (short)(timestamp - timestamp / 1000 * 1000);
        }
        ...
        /// <summary>
        ///     Transform an interval from UtcMilliTime Int64 to a .NET TimeSpan. If interval is an absolute date, TimeSpan will be
        ///     from 1970 to then
        /// </summary>
        /// <param name="interval">UtcMilliTime</param>
